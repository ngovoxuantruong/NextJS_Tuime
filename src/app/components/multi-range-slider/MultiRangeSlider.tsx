...
import styles from '@/app/styles/multiRangeSlider.module.css';
import { formatNumberWithSpaces } from '@/app/helpers/formatNumberWithSpace';
    ...
    <div className={styles.container}>
      ...
      <div className={styles.slider}>
        ...
        <div className={`${styles['slider__left-value']}`}>
          {formatNumberWithSpaces(minVal)}
        </div>
        <div className={`${styles['slider__right-value']}`}>
          {formatNumberWithSpaces(maxVal)}
        </div>
      </div>
    </div>
  );
